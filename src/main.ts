...
const flashModeButton = document.getElementById('flash-mode')!;
const listeningModeButton = document.getElementById('listening-mode')!;
...
function startPractice() {
  ...
  appState.allowNegative = (document.getElementById('negative-checkbox') as HTMLInputElement).checked;
  appState.allowDecimals = (document.getElementById('decimal-checkbox') as HTMLInputElement).checked;
